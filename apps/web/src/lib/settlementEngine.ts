...
//
// IMPORTANT: apps/api/src/modules/offlineSessions/settlementEngine.ts is the
// authoritative backend copy this file mirrors exactly (same functions,
// same behavior) — this one only drives the client-side live preview
// before Settle actually calls the server. If you change the rules here,
...
export function computeSettlement(
  ...
  const runMismatch = () => {
    ...
    // Must stay in lockstep with the API's copy of this engine.
